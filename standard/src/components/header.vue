<template>
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container-fluid px-3">
      <router-link class="navbar-brand text-big font-weight-700 line-height-1 py-3" :to="{ name: 'medi_home' }">HOME</router-link>
<!--
      <div class="navbar-collapse" id="landing-navbar-collapse">
        <div class="navbar-nav align-items-lg-center ml-auto">
          <div class="nav-item">
            <router-link class="btn btn-outline-white btn-round" :to="{ name: 'medi_home' }">
...
<script>
  ...
  export default{
    data () {
      return {
        username : Config.userName ? Config.userName + ' 님' : 'Login'
      }
    },
    computed:{
      compUserName() {
...
<!--<template>
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container-fluid px-3">
      <router-link class="navbar-brand text-big font-weight-700 line-height-1 py-3" :to="{ name: 'home' }">LuniverStarK</router-link>
